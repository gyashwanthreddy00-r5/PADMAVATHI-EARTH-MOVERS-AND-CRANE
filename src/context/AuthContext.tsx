      ...
      if (userProfile) {
        ...
        if (adminRole) {
          const appRoutes: Array<{ path: string; label_key: string; label: string; section: string; icon: string; sort_order: number }> = [
            ...
            { path: '/purchase', label_key: 'purchase', label: 'Purchase', section: 'operations', icon: 'ShoppingCart', sort_order: 36 },
            ...
            { path: '/bank', label_key: 'bank', label: 'Bank', section: 'bank', icon: 'Landmark', sort_order: 40 },
            { path: '/salary-payments', label_key: 'salaryPayments', label: 'Salary Payments', section: 'operations', icon: 'Wallet', sort_order: 41 },
          ];
